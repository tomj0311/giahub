...
from src.routes import auth_router, users_router, payments_router, uploads_router, profile_router, roles_router, role_management_router, menu_router, discovery_router, model_config_router, tool_config_router
from fastapi.middleware.cors import CORSMiddleware
import uvicorn
import logging
