...
from ai.aws.api_client import AwsApiClient
from ai.llm.base import LLM
from ai.llm.message import Message
from ai.utils.log import logger
from ai.utils.timer import Timer
from ai.utils.tools import (
...
class AwsBedrock(LLM):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from ai.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from ai.constants import AWS_PROFILE_ENV_VAR
