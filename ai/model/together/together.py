...
from ai.model.openai.chat import StreamData, Metrics
from ai.model.openai.like import OpenAILike
...
class Together(OpenAILike):
    ...
    name: Optional[str] = "Together"
    provider: Optional[str] = "Together " + id
    api_key: str = None
