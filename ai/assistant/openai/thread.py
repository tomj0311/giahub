...
from ai.assistant.openai.run import Run
from ai.assistant.openai.message import Message
from ai.assistant.openai.assistant import OpenAIAssistant
from ai.assistant.openai.exceptions import ThreadIdNotSet
...
class Thread(BaseModel):
    ...
    def print_messages(self) -> None:
        ...
        from ai.cli.console import console
