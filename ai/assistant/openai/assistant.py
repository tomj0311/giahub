...
from ai.assistant.openai.file import File
from ai.assistant.openai.exceptions import AssistantIdNotSet
from ai.tools import Tool, Toolkit
from ai.tools.function import Function
from ai.utils.log import logger, set_log_level_to_debug
...
class OpenAIAssistant(BaseModel):
    ...
    def print_response(self, message: str, markdown: bool = False) -> None:
        ...
        from ai.assistant.openai.thread import Thread
