...
class PhiTools(Toolkit):
    ...
    def create_new_app(self, template: str, workspace_name: str) -> str:
        ...
        """
        from ai.workspace.operator import create_workspace, TEMPLATE_TO_NAME_MAP, WorkspaceStarterTemplate
    ...
    def start_user_workspace(self, workspace_name: Optional[str] = None) -> str:
        ...
        :return: Status of the function or next steps.
        """
        from ai.cli.config import PhiCliConfig
        from ai.infra.type import InfraType
        from ai.workspace.config import WorkspaceConfig
        from ai.workspace.operator import start_workspace
