...
class SerperTools(Toolkit):
    def __init__(
        ...
        logger.debug(f"SerperTools configuration: num_results={num_results}")
    ...
    def search_serper(self, query: str, page: int = 1, num_results: int = 10) -> str:
        ...
        logger.debug(
            f"Search parameters: effective_num_results={effective_num_results}, requested_num_results={num_results}, page={page}"
        )
