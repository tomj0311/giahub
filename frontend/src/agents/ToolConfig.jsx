            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                <Box>
                    <Typography variant="h4" gutterBottom>
                        Tool Configuration {isEditMode && <Typography component="span" variant="body2" sx={{ color: 'warning.main' }}>(Editing)</Typography>}
                    </Typography>
                        ...
                        <CardContent>
                            {loadingDiscovery && (
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
                                    ...
                                    <Typography variant="body2">Discovering tools...</Typography>
                                </Box>
                            )}
                            ...
                            <Stack spacing={1}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                                    <Button
                                        ...
                                        disabled={saveState.loading || !form.name || !form.tool}
                                        color="primary"
                                        variant="contained"
                                        size="medium"
                                    >
                                        {saveState.loading ? 'Saving...' : isEditMode ? 'Update Tool Configuration' : 'Save Tool Configuration'}
                                    </Button>
                                </Box>
                            </Stack>
                        </CardContent>
