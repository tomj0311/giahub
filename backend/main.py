...
app.include_router(tenant_router, prefix="/api/users/tenant")
...
app.include_router(project_activities_router, prefix="/api/projects")
app.include_router(activity_notifications_router, prefix="/api/projects")
